...
function initializeButtonEventListeners() {
  ...
  document
    ...
    .addEventListener("click", () => buyCoop("chicken"));
  document
    .getElementById("buyRoosterCoop")
    .addEventListener("click", () => buyCoop("rooster"));
  document
    .getElementById("upgradeChickenCoop")
    .addEventListener("click", () => upgradeCoop("chicken"));
  document
    .getElementById("upgradeRoosterCoop")
    .addEventListener("click", () => upgradeCoop("rooster"));
  document
    .getElementById("placeChicken")
    .addEventListener("click", () => placeStoredAnimal("Chicken"));
  document
    .getElementById("placeRooster")
    .addEventListener("click", () => placeStoredAnimal("Rooster"));
  document
    .getElementById("buyAutoMerge")
    .addEventListener("click", () => buyAutoMerge());
  document
    .getElementById("upgradeAutoMerge")
    .addEventListener("click", () => upgradeAutoMerge());
...
function buyAutoMerge() {
  if (gameState.money >= GAME_CONFIG.autoMergeConfig.buyCost) {
    ...
    document.getElementById(
      "autoMergeCountdown"
    ).textContent = `Next Auto-Merge: ${gameState.autoMerge.timer.toFixed(1)}s`;
    updateMoney();
